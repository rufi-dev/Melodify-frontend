...
const ChangePassword = () => {
  ...
  const { oldPassword, password, confirmPassword } = userData;
  ...
  const handleChangePassword = async (e) => {
    ...
    // const emailData = {
    //   subject: "Password Changed - MELODIFY",
    //   send_to: user.email,
    //   reply_to: "noreply@melodify.com",
    //   template: "changePassword",
    //   url: `/resetPassword/${resetToken}`,
    // };
    try {
      const resultAction = await dispatch(changePassword(userData)).unwrap();
      if (resultAction) {
      ...
      <div className="bg-black p-10 rounded-lg shadow-3xlgreen outline-[#2b9962] w-full max-w-md">
        ...
        <form onSubmit={handleChangePassword}>
          <div className="mb-4">
            ...
            <div className="flex items-center bg-white text-black w-full rounded-lg shadow-sm px-3 gap-2 py-2">
